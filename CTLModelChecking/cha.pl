...
%Note: command line option "-nowpscalc" should disable this
     detectwps(WPSMethod),
     (member(nowpscalc,Options);wto_file(File,WPSMethod,WPoints,_)),
     ...
     %showwfacts,
     !,
     write('Write XML file'),nl,

     xmlResult(XOutput),
     write('Written XML file'),nl,
     factFile(FactFile),
